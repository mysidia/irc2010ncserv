...
#ifndef IRCD_HOSTCONF
#define IRCD_HOSTCONF  __PATH_ETC_INET"/host.conf"
#endif
#ifndef IRCDPATH_HOSTS
#define IRCDPATH_HOSTS "/etc/hosts"
#endif
...
#endif
extern const char * hostalias(const char *name);
